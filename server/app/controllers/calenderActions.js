...
const browse = async (req, res, next) => {
  try {
    ...
    const calendars = await tables.calendar.readAll();
...
const read = async (req, res, next) => {
  try {
    ...
    const calendar = await tables.calendar.read(req.params.id);
...
const edit = async (req, res, next) => {
    ...
    try {
      ...
      const result = await tables.calendar.update(id, updatedCalendar);
...
const add = async (req, res, next) => {
  ...
  try {
    ...
    const insertId = await tables.calendar.create(calendar);
...
const destroy = async (req, res, next) => {
    ...
    try {
      ...
      const result = await tables.calendar.delete(id);
